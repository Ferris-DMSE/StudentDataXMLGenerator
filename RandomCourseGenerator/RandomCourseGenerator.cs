...
namespace RandomCourseGeneratorProject
{
    public static class RandomCourseGenerator
    {
        ...
        public static Course GenerateCourse()
        {
            ...
            course.Semester = generateSemester((Semester)r.Next(4));
        ...
        public static string generateID()
        {
            ...
            Random r = new Random();
            return courseIDs[r.Next(courseIDs.Count)] + "-" + r.Next(100, 1000);
        }
